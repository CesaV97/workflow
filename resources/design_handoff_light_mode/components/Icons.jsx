// Icons — minimal inline SVGs (allowed: simple strokes).
...
function Icon({ name, size = 14, className = '' }) {
  ...
  const paths = {
    ...
    check: <><rect x="3" y="5" width="18" height="14" rx="2"/><path d="M8 12l3 3 5-6"/></>,
    chart: <><path d="M3 3v18h18"/><path d="M7 14l4-4 4 4 4-6"/></>,
